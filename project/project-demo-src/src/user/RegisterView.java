...
public class RegisterView extends JDialog {
    ...
    public RegisterView(JFrame parent, UserManager userManager) {
...
//            confirmPasswordLabel.setBounds(10, 90, 150, 30);
//            this.add(confirmPasswordLabel);
//
//            this.confirmPasswordField.setBounds(120, 90, 280, 30);
//            this.add(this.confirmPasswordField);
//            this.usernameField = new JTextField();//创建一个文本框组件,用于用户输入用户名
//            this.usernameField.setBounds(10, 10, 280, 30);
//            this.add(this.usernameField);
//
//            this.passwordField = new JPasswordField();//创建一个密码框组件,用于用户输入密码
//            this.passwordField.setBounds(10, 50, 280, 30);
//            this.add(this.passwordField);
//
//            this.confirmPasswordField = new JPasswordField();
//            this.confirmPasswordField.setBounds(10, 90, 280, 30);
//            this.add(this.confirmPasswordField);
    ...
    public static void main(String[] args) {
        new RegisterView(null, new UserManager());//创建一个RegisterView类的实例,并传入一个空的父窗口和一个UserManager类的实例
    }
}
