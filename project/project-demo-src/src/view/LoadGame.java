...
//         super(parent, "Load Game", true);//创建一个对话框，标题为Load Game，模态为true,模态对话框会阻止用户与其他窗口进行交互，直到对话框被关闭
//         this.setLayout(null);//使用linear布局，这样可以自由设置组件的位置
//         this.setSize(200, 150);//设置对话框的大小
//         setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);//设置对话框的关闭方式,这里是点击关闭按钮时销毁对话框
