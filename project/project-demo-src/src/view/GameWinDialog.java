...
public class GameWinDialog extends JDialog implements Create {
    ...
    public GameWinDialog(GameFrame parent, String gameWinMessage, int currentScore, int highScore, int step, GameController controller) {
        super(parent, "Victory", true); // 模态对话框
        ...
        homeButton.addActionListener(e -> {
            ...
            if (result == JOptionPane.YES_OPTION) {
                GameWinDialog.this.dispose(); // 关闭当前窗口
                controller.gotoHome();
                // 这里应该调用回到主页的方法
            } else {
                this.dispose();
