...
*****
版本v2.1.2 2024.5.21 by fjy

修改了一系列历史遗留问题和bug，如5x5存档问题，魔法棒清屏问题，撤销问题等

*****
版本v2.1.3 2024.5.26 by fjy
    
将原来的无法有效移动的语句输出改为了弹窗提示，更加友好
*****
版本v2.1.4 2024.5.27 by wzh

音乐播放已解决
*****
版本v2.2 2024.5.27 by wzh

整个settings全部完成，可以进行音乐选择、音量、删除账户等

*****
版本v2.3 2024.5.28 by fjy

已完成游戏胜利达到2048的逻辑，以及弹窗提示判断游戏是否继续，继续则继续游戏，否则弹出胜利窗口

*****
版本v2.3.1 2024.5.28 by fjy and wzh

存档出问题的情况已经写完了，在Usermanager中分别为101，102，103记得加上你想要的弹窗（就在输出语句的地方加就行）

修复了胜利后时间停止流逝的问题
*****
版本v2.3.2 2024.5.29 by fjy and wzh

添加了回放功能，可以回放之前的游戏记录

修复了ai模式胜利之后继续流逝的问题
*****
版本v2.3.3 2024.5.30 by fjy and wzh

添加排行榜，时间模式和普通模式的排行榜都已完成
*****
版本v3.0 2024.5.30 by fjy and wzh
